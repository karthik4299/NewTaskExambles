...
public class BaseClass {
	...
	// asserttrue
	public static void assertTrue(String name, String enterurl) {
		String url = driver.getCurrentUrl();
		boolean contains = url.contains(enterurl);
		Assert.assertTrue(name, contains);
	}

	public static void assertEqual(WebElement e, String msg, String expect) {
		String attribute = getAttribute(e, "value");
		Assert.assertEquals(msg, attribute, expect);
	}
	...
	public static File takesScreenshot(String value) throws IOException {
		...
		File f = new File(
				System.getProperty("user.dir")+"\\src\\test\\resources\\Screenshot" + value + time + ".png");
